...
int64 nChainStartTime = 1401765047;
...
const string strMessageMagic = "FBcoin Signed Message:\n";
...
int64 GetProofOfWorkReward(int nHeight, int64 nFees, uint256 prevHash)
{
	...
	if(nHeight <= 5760)
	{
		nSubsidy = 5000 * COIN;	// 5000 coins per block for the first three days.
		return nSubsidy + nFees;
	}

	if(nHeight <= 750000)
	{
		nSubsidy = 100 * COIN;	// 1000 coins per block for the first three days.
		return nSubsidy + nFees;
	}
...
bool LoadBlockIndex(bool fAllowNew)
{
    ...
    if (mapBlockIndex.empty())
    {
        ...
        // Genesis block
        const char* pszTimestamp = "Facebook pressured to refuse access to Assad campaign in Syria election";
        CTransaction txNew;
        ...
        printf("block.nNonce = %u \n", block.nNonce);
			block.print();
        assert(block.hashMerkleRoot == uint256("0xc7ac3d63e0a5105f8c517de30ae1c20039c3edeab3a50aa3975978f168104cc1"));
