...
contains(BFBCOIN_NEED_QT_PLUGINS, 1) {
    DEFINES += BFBCOIN_NEED_QT_PLUGINS
...
contains(BFBCOIN_QT_TEST, 1) {
SOURCES += src/qt/test/test_main.cpp \
    src/qt/test/uritests.cpp
HEADERS += src/qt/test/uritests.h
DEPENDPATH += src/qt/test
QT += testlib
TARGET = FBcoin-qt_test
DEFINES += BFBCOIN_QT_TEST
}
...
macx:ICON = src/qt/res/icons/FBcoin.icns
macx:TARGET = "FBcoin-Qt"
